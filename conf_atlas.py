...
q0 = np.asarray(AtlasConfig.initial_configuration)
robot_mass = pinocchio.computeTotalMass(rmodel)
ee_frame_names = ['l_foot', 'r_foot']
...
# ----------------------------------      
whole_body_task_weights = {'footTrack':{'swing':1e8, 'impact':1e8}, 'impulseVel':1e7, 'comTrack':1e7, 'stateBounds':1e3, 
                            'stateReg':{'stance':1e4, 'impact':1e5}, 'ctrlReg':{'stance':1e2, 'impact':1e3}, 'cop':20, 'frictionCone':20,
